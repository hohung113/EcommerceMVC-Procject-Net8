...
public partial class MasterContext : DbContext
{
    ...
    public virtual DbSet<Mucgiacong> Mucgiacongs { get; set; }

    public virtual DbSet<NhaCungCap> NhaCungCaps { get; set; }

    public virtual DbSet<NhanVien> NhanViens { get; set; }

    public virtual DbSet<Nhatkygc> Nhatkygcs { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=.;Persist Security Info=True;User ID=sa;Password=01676507890;Trust Server Certificate=True");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Categori__3214EC27075FBE45");

            entity.Property(e => e.Id)
                .ValueGeneratedNever()
                .HasColumnName("ID");
            entity.Property(e => e.Describle)
                .HasMaxLength(50)
                .HasColumnName("describle");
        ...
        modelBuilder.Entity<Mucgiacong>(entity =>
        {
            entity
                .HasNoKey()
                .ToTable("MUCGIACONG");
            ...
            entity.Property(e => e.Dvt)
                .HasMaxLength(20)
                .HasColumnName("DVT");
            entity.Property(e => e.Mamucgiacong)
                .HasMaxLength(10)
                .IsUnicode(false)
                .HasColumnName("MAMUCGIACONG");
            entity.Property(e => e.Tenmucgiacong)
                .HasMaxLength(20)
                .HasColumnName("TENMUCGIACONG");
        });
        ...
        modelBuilder.Entity<Nhatkygc>(entity =>
        {
            entity
                .HasNoKey()
                .ToTable("NHATKYGC");
            ...
            entity.Property(e => e.Mankgc)
                .HasMaxLength(10)
                .IsUnicode(false)
                .HasColumnName("MANKGC");
            entity.Property(e => e.Ngaygiaohang).HasColumnName("NGAYGIAOHANG");
            entity.Property(e => e.Ngaynhanhang).HasColumnName("NGAYNHANHANG");
        ...
        {
            entity.HasKey(e => e.StudentId).HasName("PK__Student__32C52B99B7572FC2");
